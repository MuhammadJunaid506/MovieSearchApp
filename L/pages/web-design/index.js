...
const WebDesign = () => {
  ...
  >
    <CustomBanner
      ...
      title={
        <>
          AFFORDABLE WEBSITE DESIGN TO <br></br>HELP
    ...
    <TwoColSection1
      ...
      title={
        <>
          <span style={{ fontSize: "30px", }}>Customized Web Design Services</span><br/>
          Best Web Design Company In USA<br/>Bringing
          <span style={{ color: "#fe1f07" }}>
            {" "}
          ...
          content: (
            <TwoColSection1
              title={
                ...
                Modernize Your Site with Professional Website Designing
                </>
              }
              onlyText
              titleColor={"black"}
    ...
    <InfoSection title={"View Our Web Design Packages"} subtitle={"Are you Ready to Get Your Business The Perfect Direction"}  />
    <Portfolio
      title={
        <>
