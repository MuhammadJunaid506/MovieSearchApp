...
const TwoColSection1 = ({ image, title, subtitle,textColor="#6A6A6A", subtitleStyles,imageStyles, text, list, opposeColumns, buttons, background, titleColor, customTitle, multitext, listItemPadding, otherSections,containerStyles }) => {
                ...
                <Row>
                    <Col span={24} style={{textAlign:'left'}}>
                        ...
                        {title && (
                            ...
                            <Typography.Title
                                level={2}
                                style={{ color: titleColor ? titleColor : "black", fontSize: 40, fontWeight: 600, marginBottom: 5 }}
                            >
                                {title}
                            </Typography.Title>
                        )}
