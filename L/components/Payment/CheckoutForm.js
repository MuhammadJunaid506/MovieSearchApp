                ...
                <div style={{ background: "#fff", padding: 20, borderRadius: 5 }}>
                    ...
                    <List.Item style={{ fontSize: 16, color: "#777", padding: "16px", textAlign: "left" }}>
                            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%" }}>
                                ...
                                <Typography.Text style={{ fontSize: 14, fontWeight: 600, color: "#fe1f07" }}>{planData?.category?.name}</Typography.Text>
                            </div>
                        </List.Item>
                        <List.Item style={{ fontSize: 16, color: "#777", padding: "16px", textAlign: "left" }}>
                            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%" }}>
                                <Typography.Text style={{ fontSize: 14, fontWeight: 600, color: "#2d2a2a" }}>Package</Typography.Text>
                                <Typography.Text style={{ fontSize: 14, fontWeight: 600, color: "#fe1f07" }}>{planData?.name}</Typography.Text>
                            </div>
                        </List.Item>
                        <List.Item style={{ fontSize: 16, color: "#777", padding: "16px", textAlign: "left" }}>
                            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%" }}>
                                <Typography.Text style={{ fontSize: 14, fontWeight: 600, color: "#2d2a2a" }}>Subtotal</Typography.Text>
                                <Typography.Text style={{ fontSize: 14, fontWeight: 600, color: "#fe1f07" }}>${planData?.price}.00</Typography.Text>
                            </div>
                        </List.Item>
                        <List.Item style={{ fontSize: 16, color: "#777", padding: "16px", textAlign: "left" }}>
                            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%" }}>
                                <Typography.Text style={{ fontSize: 14, fontWeight: 600, color: "#2d2a2a" }}>Discount</Typography.Text>
                                <Typography.Text style={{ fontSize: 14, fontWeight: 600, color: "#fe1f07" }}>- ${planData?.discountValue}.00 ({planData?.discount} %) </Typography.Text>
                            </div>
                        </List.Item>
